...
class DeepSeekClient(BaseLLMClient):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # DeepSeek API is compatible with OpenAI format, only need to specify base_url
        self.client = OpenAI(
    ...
    def analyze_section(
        ...
        """
        Analyze document section using DeepSeek API
        ...
        self._save_response(response_data, section_title, "deepseek", settings.cache_dir)
        # ================
